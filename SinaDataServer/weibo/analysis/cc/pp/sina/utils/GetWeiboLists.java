...
public class GetWeiboLists {
	...
	private static final String BASEDURL = "http://www.pp.cc/api/analysis/"; //
	...
	public static void main(String[] args) throws SQLException {
		...
		getwb.getWbLists();
		System.out.println(getwb.getAddWeibos(getwb.getUpdateUrl("6243923", "sina",
				"http://weibo.com/1642512402/A9LW8j1e3")));
	}
	...
	public void getWbLists() throws SQLException {
		...
		String data = this.getAddWeibos(getWblistUrl());
