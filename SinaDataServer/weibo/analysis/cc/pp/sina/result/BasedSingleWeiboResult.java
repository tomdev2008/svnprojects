...
public class BasedSingleWeiboResult {
	...
	private HashMap<String,String> keyusers = new HashMap<String,String>(); //15、关键账号
	private HashMap<String,String> keyusersbyfans = new HashMap<String,String>(); //关键账号(按照粉丝量)
	...
	private String purerepostratio = new String();

	// 纯转发的比例
	public String getPureRepostratio() {
		return this.purerepostratio;
	}
	public void setPureRepostratio(String purerepostratio) {
		this.purerepostratio = purerepostratio;
	}
	//0、转发次数
	...
	//15、关键账号
	public HashMap<String,String> getKeyUsers() {
		return this.keyusers;
	}
	public HashMap<String,String> getKeyUserByFans() {
		return this.keyusersbyfans;
	}
