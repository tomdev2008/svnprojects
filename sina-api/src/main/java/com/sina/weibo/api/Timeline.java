...
public class Timeline extends Weibo {
	...
	//				
	//		return Status.constructWapperStatus(response);
	//	}
	...
	//	public StatusWapper getRepostTimeline(String id, Paging page, int count)
	//			throws WeiboException {
	//		return Status.constructWapperStatus(client.get(
	//				WeiboConfig.getValue("baseURL")
	//						+ "statuses/repost_timeline.json",
	 ...
	 * @since JDK 1.5
	 */
	public Status showBatch(String ids, int trim_user) throws WeiboException {
		return new Status(client.get(WeiboConfig.getValue("baseURL") + "statuses/show_batch.json", new PostParameter[] {
				new PostParameter("ids", ids), new PostParameter("trim_user", trim_user) }));
	}
