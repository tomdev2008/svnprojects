...
import cc.pp.sina.analysis.userfans.interaction.UfiUtils;
...
public class SWeiboUtils {
	 ...
	 * @throws SQLException 
	 */
	public Status getShowStatus(WeiboJDBC weibojdbc, String url) throws WeiboException, SQLException {
	 ...
	 * @throws SQLException 
	 */
	public StatusWapper getReposts(WeiboJDBC weibojdbc, String wid, int cursor) throws WeiboException, SQLException {
	 ...
	 * @param wbinfo
	 */
	public void originalUserArrange(SimpleWeiboResult result, Status wbinfo) {
	 ...
	 * 性别分布结果整理
	 */
	public void genderArrange(SimpleWeiboResult result, int[] gender, int existwb) {
	 ...
	 * 水军结果整理
	 */
	public void qualityArrange(SimpleWeiboResult result, int[] reposterquality, int existwb) {
	 ...
	 * 关键账号结果整理，按转发量
	 */
	public void repskeyusersArrange(SimpleWeiboResult result, String[] keyusersbyreps) {

		for (int n = 0; n < 50; n++) {
			if (keyusersbyreps[n].length() > 5) {
				result.getKeyusersbyreps().put(Integer.toString(n), this.tran2Hash(keyusersbyreps[n]));
			} else {
				break;
			}
		}
	 ...
	 * 关键账号结果整理，按粉丝量
	 */
	public void fanskeyusersArrange(SimpleWeiboResult result, String[] keyusersbyfans) {

		for (int n = 0; n < 50; n++) {
			if (keyusersbyfans[n].length() > 5) {
				result.getKeyusersbyfans().put(Integer.toString(n), this.tran2Hash(keyusersbyfans[n]));
			} else {
				break;
			}
		}
	 ...
	 * @return
	 */
	public HashMap<String, String> tran2Hash(String info) {
	 ...
	 * 认证分布结果整理
	 */
	public void verifyArrange(SimpleWeiboResult result, int[] verifiedtype, int existwb) {
