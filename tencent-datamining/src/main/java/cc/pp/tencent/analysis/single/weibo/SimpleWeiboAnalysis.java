...
public class SimpleWeiboAnalysis implements Serializable {
	...
	public static void main(String[] args) throws Exception {
		...
		if (weibojdbc.mysqlStatus()) {
			int apicount = swa.analysis(weibojdbc, "http://t.qq.com/p/t/294052095500249");
	 ...
	 * @throws URIException 
	 */
	public int analysis(WeiboJDBC weibojdbc, String url) throws Exception {
		...
		// 18、总体评价
		/***********中间变量初始化************/
		int rcount, ccount, city, existwb = 0, wbsum = 0, cursor = 0;
